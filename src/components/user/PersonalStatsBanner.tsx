...
export function PersonalStatsBanner() {
  ...
  return (
    <div className="bg-gradient-to-r from-teal-600 to-teal-700 dark:from-teal-800 dark:to-teal-900 rounded-2xl p-4 shadow-lg">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-teal-100 dark:text-teal-200">Current Streak</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-teal-100 dark:text-teal-200">Today's Verses</p>
              <p className="text-2xl font-bold text-white">
                {displayTodayVerses.toLocaleString()}
              </p>
            </div>
          </div>
        </div>
